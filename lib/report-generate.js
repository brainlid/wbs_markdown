...
//
// `markdownFilename` - The full path of the input markdown file.
// `outputReportFilename` - The full path of the output report file.
function watching(markdownFilename, outputReportFilename) {
  ...
  return
    fs.watch(markdownFilename, function(eventType, filename) {
      if (eventType == "change") {
