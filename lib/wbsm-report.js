...
function generate(markdownFilename, reportFilename, renderTemplateFilename) {
  ...
  htmlFragment = htmlFragment.replace(/\<li\s?/ig, '<wbs-item v-on:register="registered" v-on:togglestory="toggleStory" :story_work="story_work" :active_stories="active_stories" :stories="checked_stories" :showmode="show_mode" ');
  ...
  report = report.replace('<p id="stories-chart">chart</p>', '<stories-chart :story_work="story_work" :stories="checked_stories"></stories-chart>');
  report = report.replace('<p id="stories-table">table</p>', '<stories-table :story_work="story_work" :stories="checked_stories"></stories-table>');
  report = report.replace('<p id="stories-toggle">toggle</p>', '<stories-toggle v-on:toggle="toggleAllStories"></stories-toggle>');
  report = report.replace('<p id="stories-total">total</p>', '<stories-total :story_work="story_work" :stories="checked_stories"></stories-total>');
  report = report.replace('<p id="story-test">test</p>', '<story-test :active_stories="active_stories" v-on:togglestory="toggleStory"></story-test>');
